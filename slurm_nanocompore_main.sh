...
nanocompore sampcomp --allow_warnings --log_level debug --fasta ${1} --sample_yaml ${2} -o ${3}

#/home/tjakobi/.cache/pypoetry/virtualenvs/nanocompore-NmxgQRJS-py3.6/bin/nanocompore sampcomp --nthreads 40 --allow_warnings --log_level debug --fasta ${1} --sample_yaml ${2} -o ${3}
