...
#parallel ln -s `pwd`/{1}_mate{2}_STARmapping/Chimeric.out.junction ../$DEST/{1}.mate{2}.Chimeric.out.junction ::: * ::: 1 2
#parallel ln -s `pwd`/{1}_mate{2}_STARmapping/Aligned.noS.bam ../$DEST/{1}.mate{2}.bam ::: * ::: 1 2 
#parallel ln -s `pwd`/{1}_mate{2}_STARmapping/Aligned.noS.bam.bai ../$DEST/{1}.mate{2}.bam.bai ::: * ::: 1 2
